    ...
    public partial class stoch : System.Web.UI.Page
    {
            ...
            if (Session["EMAILID"] != null)
            {
                if ((Request.QueryString["symbol"] != null) && (Request.QueryString["exchange"] != null) &&
                    ...
                    (Request.QueryString["interval"] != null) && (Request.QueryString["fastkperiod"] != null) &&
                        (Request.QueryString["slowdperiod"] != null) )
                {
                    this.Title = "STOCHASTIC graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void FillData()
        {
            ...
            if ((ViewState["FetchedData"] == null) || (((DataTable)ViewState["FetchedData"]).Rows.Count == 0))
            {
                ...
                dailyData = stockManager.getSTOCHDataTableFromDaily(symbol, exchange, seriestype, outputsize, time_interval: interval,
                                fromDate: ((fromDate == null) || (fromDate.Equals(""))) ? null : fromDate, fastkperiod: fastkperiod,
                               slowdperiod: slowdperiod);
                //dailyData = stockManager.getSTOCHDataTableFromDaily(symbol, exchange, seriestype, outputsize, time_interval: interval,
                //fromDate: ((fromDate == null) || (fromDate.Equals(""))) ? null : fromDate, fastkperiod: fastkperiod, slowkperiod: slowkperiod,
                //slowdperiod: slowdperiod, slowkmatype: slowkmatype, slowdmatype: slowdmatype, bRSIRequired: true, rsiPeriod: "14");
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    chartStdGraph.DataManipulator.FinancialFormula(FinancialFormula.StochasticIndicator,
                    ...
                    if (chartStdGraph.Series.FindByName("K-FastLine") != null)
                    {
                        chartStdGraph.Series["K-FastLine"].PostBackValue = "K-FastLine:" + textboxSTOCH_Fastkperiod.Text + "," + symbol + "," + "#VALX,#VALY{0.##}";

                    }
                    if (chartStdGraph.Series.FindByName("D-SlowLine") != null)
                    {
                        chartStdGraph.Series["D-SlowLine"].PostBackValue = "D-SlowLine:" + textboxSTOCH_Slowdperiod.Text + "," + symbol + "," + "#VALX,#VALY{0.##}";
                    }
                }
        ...
        protected void chartStdGraph_Click(object sender, ImageMapEventArgs e)
        {
            ...
            try
            {
                ...
                else if (seriesName.Contains("K-FastLine"))
                {
