    ...
    public partial class rsi : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "RSI graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void FillData()
        {
            ...
            {
                dailyData = stockManager.getRSIDataTableFromDaily(symbol, exchange, seriestype, outputsize, time_interval: interval,
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    //Chart.DataManipulator.FinancialFormula(FinancialFormula.RelativeStrengthIndex,"Period,StdDev","Price","UpperBand,LowerBand")
                    //The following example takes input from Series1's fourth Y value (Series1:Y4) and outputs the relative strength indicator on Series2 (Series2:Y).
                    //It also specifies a period of 15 days.
                    //Chart1.DataManipulator.FinancialFormula (FinancialFormula.RelativeStrengthIndex, "15", "Series1:Y4", "Series2:Y")
                    chartStdGraph.DataManipulator.FinancialFormula(FinancialFormula.RelativeStrengthIndex, textboxPeriod.Text, "OHLC:Y4", "RSI:Y");

                    int pointstomove = Int32.Parse(textboxPeriod.Text);
                    ...
                    if (chartStdGraph.Series.FindByName("RSI") != null)
                    {
                        chartStdGraph.Series["RSI"].PostBackValue = "RSI-" + textboxPeriod.Text + "," + symbol + "," + "#VALX,#VALY{0.##}";
                    }
                }
