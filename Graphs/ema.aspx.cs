...
namespace Analytics
{
    public partial class ema : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                if ((Request.QueryString["symbol"] != null) && (Request.QueryString["exchange"] != null) &&
                    ...
                    (Request.QueryString["interval"] != null) && (Request.QueryString["smallperiod"] != null))
                {
                    this.Title = "EMA graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        textboxSmallPeriod.Text = Request.QueryString["smallperiod"];
                        if (Request.QueryString["longperiod"] != null)
                        {
                            textboxLongPeriod.Text = Request.QueryString["longperiod"];
                        }
                    }
        ...
        public void fillLinesCheckBoxes()
        {
            ...
            li = new ListItem("EMA SMALL", "EMA_SMALL");
            li.Selected = true;
            Master.checkboxlistLines.Items.Add(li);

            li = new ListItem("EMA LONG", "EMA_LONG");
            li.Selected = true;
            Master.checkboxlistLines.Items.Add(li);
        ...
        public void FillData()
        {
            ...
            int smallperiod = Int32.Parse(textboxSmallPeriod.Text);
            int longperiod = Int32.Parse(textboxLongPeriod.Text);
            ...
            if ((ViewState["FetchedData"] == null) || (((DataTable)ViewState["FetchedData"]).Rows.Count == 0))
            {
                dailyData = stockManager.GetSMA_EMA_MACD_BBANDS_Table(symbol, exchange, seriestype, outputsize, time_interval: interval,
                                fromDate: ((fromDate == null) || (fromDate.Equals(""))) ? null : fromDate, small_fast_Period: smallperiod, long_slow_Period: longperiod, emaRequired: true);
                if (dailyData != null)
                {
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    if (chartStdGraph.Series.FindByName("EMA_SMALL") != null)
                    {
                        chartStdGraph.Series["EMA_SMALL"].PostBackValue = "EMA SMALL-" + textboxSmallPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                    if (chartStdGraph.Series.FindByName("EMA_LONG") != null)
                    {
                        chartStdGraph.Series["EMA_LONG"].PostBackValue = "EMA LONG-" + textboxLongPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                }
        ...
        protected void chartStdGraph_Click(object sender, ImageMapEventArgs e)
        {
            ...
            try
            {
                ...
                else if (seriesName.Contains("EMA"))
                {
