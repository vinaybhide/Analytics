...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
        ...
        <div style="width: 100%; border: groove;">
            ...
            <table style="width: 100%;">
                <tr style="width: 100%;">
                    <td style="width: 20%;"></td>
                    <td style="text-align: right; width: 10%;">
                        <asp:Label ID="Label5" runat="server" Text="Small Period: "></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="textboxSmallPeriod" runat="server" TextMode="Number" Text="20" TabIndex="2"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table style="width: 100%;">
                <tr style="width: 100%;">
                    <td style="width: 20%;"></td>
                    <td style="text-align: right; width: 10%;">
                        <asp:Label ID="Label3" runat="server" Text="Long Period: "></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="textboxLongPeriod" runat="server" TextMode="Number" Text="-1" TabIndex="2"></asp:TextBox>
                    </td>
                </tr>
            </table>
    ...
    <asp:Chart ID="chartStdGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="SMA_SMALL" XAxisType="Primary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea3" Legend="legendStdGraph" 
                LegendText="SMA Small"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="SMA_SMALL" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; SMA Small Value:#VALY">
            </asp:Series>
            <asp:Series Name="SMA_LONG" XAxisType="Primary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea3" Legend="legendStdGraph" 
                LegendText="SMA Long"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="SMA_LONG" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; SMA Long Value:#VALY">
            </asp:Series>
        ...
        <ChartAreas>
            ...
            <asp:ChartArea Name="chartarea3" AlignWithChartArea="chartarea1" AlignmentOrientation="Vertical" AlignmentStyle="PlotPosition">
                ...
                <AxisY Title="SMA" TitleAlignment="Center" IsMarginVisible="false" IsLabelAutoFit="true" LabelAutoFitStyle="DecreaseFont"
                    TitleFont="Microsoft Sans Serif, 8pt" IsStartedFromZero="false">
                    <LabelStyle Font="Microsoft Sans Serif, 8pt" />
                </AxisY>
            </asp:ChartArea>
