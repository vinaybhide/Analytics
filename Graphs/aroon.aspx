...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
        ...
        <div style="width: 100%; border: groove;">
            ...
            <table style="width: 100%;">
                <tr style="width: 100%;">
                    ...
                    <td>
                        <asp:TextBox ID="textboxPeriod" runat="server" TextMode="Number" Text="20" TabIndex="2"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table style="width: 100%;">
    ...
    <asp:Chart ID="chartStdGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="Aroon Down" XAxisType="Primary" YAxisType="Primary" Legend="legendStdGraph" LegendText="AROON Down" ChartType="Line" ChartArea="chartarea3"
        ...
        <Series>
            <asp:Series Name="Aroon Up" XAxisType="Primary" YAxisType="Primary" Legend="legendStdGraph" LegendText="AROON Up" ChartType="Line" ChartArea="chartarea3"
