    ...
    public partial class sma : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "SMA graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void FillData()
        {
            ...
            if ((ViewState["FetchedData"] == null) || (((DataTable)ViewState["FetchedData"]).Rows.Count == 0))
            {
                dailyData = stockManager.GetSMA_EMA_MACD_BBANDS_Table(symbol, exchange, seriestype, outputsize, time_interval: interval,
                                fromDate: ((fromDate == null) || (fromDate.Equals(""))) ? null : fromDate, small_fast_Period: smallperiod, long_slow_Period: longperiod);
                if (dailyData != null)
                {
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    if (chartStdGraph.Series.FindByName("SMA_SMALL") != null)
                    {
                        chartStdGraph.Series["SMA_SMALL"].PostBackValue = "SMA SMALL-" + textboxSmallPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                    if (chartStdGraph.Series.FindByName("SMA_LONG") != null)
                    {
                        chartStdGraph.Series["SMA_LONG"].PostBackValue = "SMA LONG-" + textboxLongPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                }
        ...
        protected void chartStdGraph_Click(object sender, ImageMapEventArgs e)
        {
            ...
            try
            {
                ...
                else if (seriesName.Contains("SMA"))
                {
