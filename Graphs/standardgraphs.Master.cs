    ...
    public partial class standardgraphs : System.Web.UI.MasterPage
    {
        ...
        protected void GetIndexValues(object sender, EventArgs e)
        {
            ...
            if (myDeserializedClass != null)
            {
                ...
                //DateTime myDate = new DateTime(1970, 1, 1, 0, 0, 0, 0).AddSeconds(myResult.timestamp.Last());
                ...
                //myDate = new DateTime(1970, 1, 1, 0, 0, 0, 0).AddSeconds(myResult.timestamp.Last());
