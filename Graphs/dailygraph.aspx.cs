    ...
    public partial class dailygraph : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "Daily Price graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        ddl_SeriesType.SelectedValue = Request.QueryString["seriestype"];
                    }
        ...
        public void FillData()
        {
            ...
            {
                dailyData = stockManager.GetStockPriceData(symbol, exchange, seriestype, outputsize, time_interval: "1d",
