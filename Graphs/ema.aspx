...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
    ...
    <asp:Chart ID="chartStdGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="EMA_SMALL" XAxisType="Primary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea3" Legend="legendStdGraph" 
                LegendText="EMA Small"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="EMA_SMALL" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; EMA SMALL:#VALY">
            </asp:Series>
            <asp:Series Name="EMA_LONG" XAxisType="Primary" YAxisType="Primary" ChartType="Line" ChartArea="chartarea3" Legend="legendStdGraph" 
                LegendText="EMA Long"
                XValueMember="TIMESTAMP" XValueType="Date" YValueMembers="EMA_LONG" YValueType="Double"
                PostBackValue="#VALX,#VALY" ToolTip="Date:#VALX; EMA LONG:#VALY">
            </asp:Series>
        </Series>
        <ChartAreas>
