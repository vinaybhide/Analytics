    ...
    public partial class aroon : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "AROON graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    if (chartStdGraph.Series.FindByName("Aroon Down") != null)
                    {
                        chartStdGraph.Series["Aroon Down"].PostBackValue = "Aroon Down-" + textboxPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                    if (chartStdGraph.Series.FindByName("Aroon Up") != null)
                    {
                        chartStdGraph.Series["Aroon Up"].PostBackValue = "Aroon Up-" + textboxPeriod.Text + "," + symbol + "," + "#VALX,#VALY";
                    }
                }
                if ((valuationTable != null) && (valuationTable.Rows.Count > 0))
                {
                    if (chartStdGraph.Series.FindByName(symbol) == null)
                    {
                        ...
                        (chartStdGraph.Series[symbol]).YValuesPerPoint = 2;
