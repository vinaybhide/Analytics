...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
    ...
    <asp:Chart ID="chartStdGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="Lower Band" XAxisType="Secondary" YAxisType="Primary" Legend="legendStdGraph" LegendText="Lower Band" ChartType="Line" ChartArea="chartarea1"
            ...
            <asp:Series Name="Middle Band" XAxisType="Secondary" YAxisType="Primary" Legend="legendStdGraph" LegendText="Middle Band" ChartType="Line" ChartArea="chartarea1"
            ...
            <asp:Series Name="Upper Band" XAxisType="Secondary" YAxisType="Primary" Legend="legendStdGraph" LegendText="Upper Band" ChartType="Line" ChartArea="chartarea1"
        ...
        <ChartAreas>
            <asp:ChartArea Name="chartarea1" AlignmentOrientation="Vertical" AlignmentStyle="PlotPosition">
                ...
                <AxisY Title="Daily/Upper Band/SMA/Lower Band" TitleAlignment="Center" IsMarginVisible="false" IsLabelAutoFit="true" LabelAutoFitStyle="DecreaseFont"
