    ...
    public partial class intraday : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "Intra-day Price : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void FillData()
        {
            ...
            {
                dailyData = stockManager.GetStockPriceData(symbol, exchange, seriestype, outputsize, time_interval: interval,
