        ...
        <table style="width: 100%;">
            ...
            <tr style="width: 100%; border-color: black; border-top-style: solid; border-width: 1px;">
                ...
                <td style="width: 80%">
                    ...
                    <asp:TextBox ID="textboxMACD_SignalPeriod" runat="server" TextMode="Number" Text="9" TabIndex="5"></asp:TextBox><br />
                </td>
            </tr>
            <tr style="width: 100%; border-color: black; border-top-style: solid; border-width: 1px;">
                <td style="width: 20%;">
                ...
                <td style="width: 80%">
                    ...
                    <asp:TextBox ID="textboxAroon_Period" runat="server" TextMode="Number" Text="20" TabIndex="3"></asp:TextBox><br />
                </td>
            </tr>
            <tr style="width: 100%; border-color: black; border-top-style: solid; border-width: 1px;">
                <td style="width: 20%;">
                ...
                <td style="width: 80%">
                    ...
                    <asp:TextBox ID="textboxAdx_Period" runat="server" TextMode="Number" Text="20" TabIndex="2"></asp:TextBox><br />
                </td>
            </tr>
            <tr style="width: 100%; border-color: black; border-top-style: solid; border-width: 1px;">
                <td style="width: 20%;">
                ...
                <td style="width: 80%">
                    ...
                    <asp:TextBox ID="textboxBBands_NbdevDn" runat="server" TextMode="Number" Text="2" TabIndex="5"></asp:TextBox><br />
                </td>
            </tr>
            <tr style="width: 100%; border-color: black; border-top-style: double; border-bottom-style:solid; border-width: 1px;">
                <td colspan="2" style="width: 100%;">
                    <asp:Label ID="textboxMessage" runat="server" Text="Message:"></asp:Label><br />
                </td>
            </tr>
        </table>
    </div>
