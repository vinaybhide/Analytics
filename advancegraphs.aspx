<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="advancegraphs.aspx.cs" Inherits="Analytics.advancegraphs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table style="border: solid; border-width: thin; width: 100%">
            ...
            <tr>
                <td rowspan="2" style="text-align: center; border: black; border-style: solid; border-width: 1px;">
            ...
            <tr>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    ...
                    <asp:TextBox ID="textboxMACDEMADaily_fastperiod" runat="server" TextMode="Number" Text="12" ReadOnly="true" TabIndex="19"></asp:TextBox>
                    <asp:Label ID="Label29" runat="server" Text="Slow Period:"></asp:Label>
                    <asp:TextBox ID="textboxMACDEMADaily_slowperiod" runat="server" TextMode="Number" Text="26" ReadOnly="true" TabIndex="22"></asp:TextBox>
                    <asp:Label ID="Label27" runat="server" Text="Signal Period:"></asp:Label>
                    <asp:TextBox ID="textboxMACDEMADaily_signalperiod" runat="server" TextMode="Number" Text="9" ReadOnly="true" TabIndex="22"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td rowspan="3" style="text-align: center; border-color: black; border-style: solid; border-width: 1px;">
                    <asp:Button ID="buttonRSIDaily" Text="Momentum Indicator" runat="server" TabIndex="23" OnClick="buttonRSIDaily_Click" />
                </td>
            </tr>
            <tr>
                <td style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label28" runat="server" Text="Daily OHLC"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label31" runat="server" Text="Output size:"></asp:Label>
                    <asp:DropDownList ID="ddlRSIDaily_Outputsize" runat="server" TabIndex="24">
                        <asp:ListItem Value="compact">Compact</asp:ListItem>
                        <asp:ListItem Value="full" Selected="True">Full</asp:ListItem>
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                <td style="text-align: center; border-color: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label30" runat="server" Text="RSI"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label32" runat="server" Text="Interval:"></asp:Label>
                    <asp:DropDownList ID="ddlRSIDaily_Interval" runat="server" TabIndex="25">
                        <asp:ListItem Value="1min" Enabled="false">1 min</asp:ListItem>
                        <asp:ListItem Value="5min" Enabled="false">5 min</asp:ListItem>
                        <asp:ListItem Value="15min" Enabled="false">15 min</asp:ListItem>
                        <asp:ListItem Value="30min" Enabled="false">30 min</asp:ListItem>
                    ...
                    <asp:TextBox ID="textboxRSIDaily_Period" runat="server" TextMode="Number" Text="20" TabIndex="26"></asp:TextBox>
                    <asp:Label ID="Label34" runat="server" Text="Series Type:"></asp:Label>
                    <asp:DropDownList ID="ddlRSIDaily_SeriesType" runat="server" TabIndex="27">
                        <asp:ListItem Value="open" Enabled="false">Open</asp:ListItem>
                        <asp:ListItem Value="high" Enabled="false">High</asp:ListItem>
                        <asp:ListItem Value="low" Enabled="false">Low</asp:ListItem>
                        <asp:ListItem Value="close" Selected="True">Close</asp:ListItem>
            ...
            <tr>
                <td rowspan="5" style="text-align: center; border-color: black; border-style: solid; border-width: 1px;">
                    <asp:Button ID="buttonBBandsDaily" Text="Gauge Trends" runat="server" TabIndex="27" OnClick="buttonBBandsDaily_Click" />
                </td>
            </tr>
            <tr>
                <td style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label35" runat="server" Text="Daily OHLC"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label36" runat="server" Text="Output size:"></asp:Label>
            ...
            <tr>
                <td rowspan="3" style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label37" runat="server" Text="BBand"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    ...
                    <asp:TextBox ID="textboxBBandsDaily_Period" runat="server" TextMode="Number" Text="20" TabIndex="30"></asp:TextBox>
                    <asp:Label ID="Label41" runat="server" Text="Series Type:"></asp:Label>
            ...
            <tr>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    ...
                    <asp:TextBox ID="textboxBBandsDaily_NbdevUp" runat="server" TextMode="Number" Text="2" TabIndex="32"></asp:TextBox><br />
                </td>
            </tr>
            <tr>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label43" runat="server" Text="Deviation multiplier for lower band(nbDevDn):"></asp:Label>
                    <asp:TextBox ID="textboxBBandsDaily_NbdevDn" runat="server" TextMode="Number" Text="2" TabIndex="33"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td rowspan="7" style="text-align: center; border-color: black; border-style: solid; border-width: 1px;">
                    <asp:Button ID="buttonStochDaily" Text="Buy & Sell Indicator" runat="server" TabIndex="34" OnClick="buttonStochDaily_Click" />
                </td>
            </tr>
            <tr>
                <td style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label44" runat="server" Text="Daily OHLC"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label45" runat="server" Text="Output size:"></asp:Label>
            ...
            <tr>
                <td rowspan="4" style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label46" runat="server" Text="Stochastics"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label47" runat="server" Text="Interval:"></asp:Label>
            ...
            <tr>
                <td rowspan="1" style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label54" runat="server" Text="RSI"></asp:Label>
                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label55" runat="server" Text="Interval:"></asp:Label>
                    <asp:DropDownList ID="ddlStochDailyRSI_Interval" runat="server" TabIndex="25">
                        <asp:ListItem Value="1min" Enabled="false">1 min</asp:ListItem>
                        <asp:ListItem Value="5min" Enabled="false">5 min</asp:ListItem>
                        <asp:ListItem Value="15min" Enabled="false">15 min</asp:ListItem>
                        <asp:ListItem Value="30min" Enabled="false">30 min</asp:ListItem>
            ...
            <tr>
                <td rowspan="6" style="text-align: center; border-color: black; border-style: solid; border-width: 1px;">
            ...
            <tr>
                <td style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label66" runat="server" Text="+vw Directional Movement(+DI)"></asp:Label>
            ...
            <tr>
                <td style="text-align: center; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label69" runat="server" Text="Avg Directional Movement Index(ADX)"></asp:Label>

                </td>
                <td style="padding-left: 1%; border: black; border-style: solid; border-width: 1px;">
                    <asp:Label ID="Label70" runat="server" Text="Interval:"></asp:Label>
