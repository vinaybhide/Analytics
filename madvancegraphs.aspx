...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%; border-color: black; border-style: solid; border-width: 1px; ">
        <tr>
            <td style="text-align: right; width: 50%;">
                <asp:Label ID="Label71" runat="server" Style="text-align: right" Text="Select Exchange:"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: right; width: 50%;">
                <asp:Label ID="Label69" runat="server" Style="text-align: right" Text="Filter by Company name :"></asp:Label>
            </td>
            <td>
    ...
    <table style="width: 100%; border-color: black; border-style: solid; border-width: 1px; ">
        <tr>
            <td style="text-align: right; width: 50%;">
                <asp:Label ID="label40" Text="Select Portfolio to search stock :" runat="server"></asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="ddlPortfolios" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlPortfolios_SelectedIndexChanged"></asp:DropDownList>
            </td>
            <%--<td>
    ...
    <table style="width: 100%; border-color: black; border-style: solid; border-width: 1px; ">
        ...
        <tr>
            <td style="text-align: right; width: 50%;">
                <asp:Label ID="label70" Text="Select stock or company :" runat="server"></asp:Label>
            </td>
            <td colspan="2">
