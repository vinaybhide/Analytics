    ...
    public partial class bbandsdaily : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["EMAILID"] != null)
            {
                ...
                {
                    this.Title = "Trend Gauger graph : " + Request.QueryString["symbol"].ToString() + "." + Request.QueryString["exchange"].ToString();
        ...
        public void FillData()
        {
            ...
            int stddev = Int32.Parse(textboxStdDeviation.Text);
        ...
        public void ShowGraph()
        {
            ...
            try
            {
                ...
                if (scriptData != null)
                {
                    ...
                    chartAdvGraph.DataManipulator.FinancialFormula(FinancialFormula.BollingerBands, textboxPeriod.Text + "," + textboxStdDeviation.Text,
                        "OHLC:Y4", "Upper Band:Y,Lower Band:Y");

                    chartAdvGraph.DataManipulator.FinancialFormula(FinancialFormula.MovingAverage, textboxPeriod.Text, "OHLC:Y4", "Middle Band:Y");
        ...
        protected void chartAdvGraph_Click(object sender, ImageMapEventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    HA.AxisY = chartAdvGraph.ChartAreas[0].AxisY2;
                //    VA.AxisY = chartAdvGraph.ChartAreas[0].AxisY2;
                //    ra.AxisY = chartAdvGraph.ChartAreas[0].AxisY2;
