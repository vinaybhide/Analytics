        ...
        public void ShowSymbolValuation()
        {
            ...
            if ((valuationTable != null) && (valuationTable.Rows.Count > 0))
            {
                ...
                if (chartAdvGraph.Series.FindByName(symbol + "." + exchange) == null)
                {
                    ...
                    chartAdvGraph.Series[symbol + "." + exchange].XValueType = ChartValueType.DateTime;
                ...
                chartAdvGraph.Series[symbol + "." + exchange].ToolTip = "Portfolio: " + "Date:#VALX{g}; Close:#VALY (Click to see details)";
                chartAdvGraph.Series[symbol + "." + exchange].PostBackValue = "Portfolio:" + ",#VALX{g},#VALY";
