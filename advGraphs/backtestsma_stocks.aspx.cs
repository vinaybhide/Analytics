    ...
    public partial class backtestsma_stocks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["EMAILID"] != null)
            {
                ...
                this.Title = "BackTest Graph for: " + Master.textbox_SelectedSymbol.Text;
        ...
        public void ShowSymbolValuation()
        {
            ...
            if ((valuationTable != null) && (valuationTable.Rows.Count > 0))
            {
                ...
                if (chartBackTest.Series.FindByName(symbol + "." + exchange) == null)
                {
                    chartBackTest.Series.Add(symbol + "." + exchange);

                    chartBackTest.Series[symbol + "." + exchange].Name = symbol + "." + exchange; // "Portfolio";
                    chartBackTest.Series[symbol + "." + exchange].ChartType = SeriesChartType.Line;
                    chartBackTest.Series[symbol + "." + exchange].ChartArea = chartBackTest.ChartAreas[0].Name;
                    chartBackTest.Series[symbol + "." + exchange].Legend = chartBackTest.Legends[0].Name;

                    chartBackTest.Series[symbol + "." + exchange].XAxisType = AxisType.Secondary;
                    chartBackTest.Series[symbol + "." + exchange].YAxisType = AxisType.Primary;

                    chartBackTest.Series[symbol + "." + exchange].XValueType = ChartValueType.Date;
                    chartBackTest.Series[symbol + "." + exchange].YValueType = ChartValueType.Double;
                }
                else
                {
                    chartBackTest.Series[symbol + "." + exchange].Enabled = true;
                }
                chartBackTest.Series[symbol + "." + exchange].LegendText = symbol + "." + exchange;//valuationTable.Rows[0]["SYMBOL"].ToString() + "." + valuationTable.Rows[0]["EXCHANGE"].ToString();
                chartBackTest.Series[symbol + "." + exchange].LegendToolTip = symbol + "." + exchange;// valuationTable.Rows[0]["SYMBOL"].ToString();
                chartBackTest.Series[symbol + "." + exchange].ToolTip = "Portfolio: " + "Date:#VALX; Close:#VALY (Click to see details)";
                chartBackTest.Series[symbol + "." + exchange].PostBackValue = "Portfolio:" + ",#VALX,#VALY";

                chartBackTest.Series[symbol + "." + exchange].Points.Clear();
                ...
                for (int rownum = 0; rownum < valuationTable.Rows.Count; rownum++)
                {
                    ...
                    chartBackTest.Series[symbol + "." + exchange].Points.AddXY(valuationTable.Rows[rownum]["TIMESTAMP"], valuationTable.Rows[rownum]["CLOSE"]);
                    chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].PostBackValue =
                                        "Portfolio," +
                    ...
                    {
                        chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerSize = 11;
                        chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerStyle = MarkerStyle.Diamond;
                        chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerColor = Color.Black;
                        chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].ToolTip = "Transaction: " + portfolioTxnNumber++;
                    }
                }
                chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerSize = 10;
                chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerStyle = MarkerStyle.Diamond;
                chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].MarkerColor = Color.Black;
                chartBackTest.Series[symbol + "." + exchange].Points[chartBackTest.Series[symbol + "." + exchange].Points.Count - 1].ToolTip = "Click to see latest valuation";
