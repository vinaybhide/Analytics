...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderGraphs" runat="server">
    ...
    <asp:Chart ID="chartAdvGraph" runat="server" CssClass="chart" Visible="false" BorderlineColor="Black" BorderlineDashStyle="Solid"
        ...
        <Series>
            ...
            <asp:Series Name="MINUS_DI" YAxisType="Primary" XAxisType="Primary" ChartType="Line" ChartArea="chartarea2"
            ...
            <asp:Series Name="PLUS_DI" YAxisType="Primary" XAxisType="Primary" ChartType="Line" ChartArea="chartarea2"
            ...
            <asp:Series Name="ADX" YAxisType="Primary" XAxisType="Primary" ChartType="Line" ChartArea="chartarea2"
        ...
        <ChartAreas>
            ...
            <asp:ChartArea Name="chartarea2" AlignWithChartArea="chartarea1" AlignmentOrientation="Vertical" AlignmentStyle="PlotPosition">
                ...
                <AxisY Title="ADX/Directional Movement Index(DI)" TitleAlignment="Center" IsMarginVisible="false" IsLabelAutoFit="true" LabelAutoFitStyle="DecreaseFont"
